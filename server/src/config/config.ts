import { RtpCodecCapability, WorkerSettings, WebRtcTransportOptions, TransportListenInfo } from "mediasoup/node/lib/types"


export const config: {
    workerSettings: WorkerSettings,
    routerMediaCodecs: Partial<RtpCodecCapability>[]
